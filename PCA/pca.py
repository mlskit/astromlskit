...
mu_vec1 = np.array([0,0,2])
cov_mat1 = np.array([[1,0,0],[0,1,0],[0,0,1]])
class1_sample = np.random.multivariate_normal(mu_vec1, cov_mat1, 2000).T
if class1_sample.shape == (3,2000):
    print "The matrix has not the dimensions 3x20"
#u get the data here no need of mean and covariance matrcx
print class1_sample

mu_vec2 = np.array([1,1,1])
cov_mat2 = np.array([[1,0,0],[0,1,0],[0,0,1]])
class2_sample = np.random.multivariate_normal(mu_vec2, cov_mat2, 2000).T
if class1_sample.shape == (3,2000):
    print "The matrix has not the dimensions 3x20"
...
print all_samples
assert all_samples.shape == (3,4000), "The matrix has not the dimensions 3x40"
...
plt.plot(transformed[0,0:2000], transformed[1,0:2000],\
     'o', markersize=7, color='blue', alpha=0.5, label='class1')
plt.plot(transformed[0,2000:4000], transformed[1,2000:4000],
